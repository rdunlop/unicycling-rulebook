class UserMailer < TenantAwareMailer
  default return_path: (Rails.configuration.mail_full_email || "unicycling@dunlopweb.com")

  def create_from(from_name = Rails.configuration.mail_from_name, from_email = Rails.configuration.mail_full_email)
    if from_email.nil?
